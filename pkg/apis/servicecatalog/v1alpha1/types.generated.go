...
func (x *ServicePlan) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			yyq2[1] = x.APIVersion != ""
			yyq2[2] = true
			yyq2[5] = x.Bindable != nil
			yyq2[8] = x.ServiceInstanceCreateParameterSchema != nil
			yyq2[9] = x.ServiceInstanceUpdateParameterSchema != nil
			yyq2[10] = x.ServiceInstanceCredentialCreateParameterSchema != nil
			var yynn2 int
			if yyr2 || yy2arr2 {
...
func (x *ServiceInstanceSpec) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		yyv24 := &x.ParametersFrom
		yym25 := z.DecBinary()
		_ = yym25
		if false {
		} else {
			h.decSliceParametersFromSource((*[]ParametersFromSource)(yyv24), d)
		}
	}
	yyj17++
	if yyhl17 {
...
func (x *ServiceInstanceStatus) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			yyq2[7] = x.InProgressProperties != nil
			yyq2[8] = x.ExternalProperties != nil
			var yynn2 int
			if yyr2 || yy2arr2 {
